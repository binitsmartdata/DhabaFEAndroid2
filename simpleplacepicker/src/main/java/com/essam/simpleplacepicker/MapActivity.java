...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private double latitude_predefined = 0;
    private double longitude_predefined = 0;
    ...
    private void receiveIntent() {
        ...
        if (intent.hasExtra(SimplePlacePicker.LATITUDE)) {
            latitude_predefined = intent.getDoubleExtra(SimplePlacePicker.LATITUDE, 0);
        }
        if (intent.hasExtra(SimplePlacePicker.LONGITUDE)) {
            longitude_predefined = intent.getDoubleExtra(SimplePlacePicker.LONGITUDE, 0);
        }
...
//                ToDo : you can use retrofit for this network call instead of using services
    ...
    private void getDeviceLocation() {
        if (latitude_predefined != 0 && longitude_predefined != 0) {
            // NAVIGATE TO THE PREVIOUS SELECTED LOCATION.
            mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(latitude_predefined, longitude_predefined), DEFAULT_ZOOM));
        } else {
