...
import com.transport.mall.databinding.FragmentNewOrdersBinding
...
class NewOrdersFragment : BaseFragment<FragmentNewOrdersBinding, BaseVM>(),
    RecyclerCallback {
    override val layoutId: Int
        get() = R.layout.fragment_new_orders
    override var viewModel: BaseVM
        get() = setUpVM(this, BaseVM(baseActivity.application))
        set(value) {}
    override var binding: FragmentNewOrdersBinding
        get() = setUpBinding()
        set(value) {}
